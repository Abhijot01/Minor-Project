...
try:
    ...
    plt.title('Performance Comparison of Machine Learning Models (Hindi Cleaned Output 3)')
    plt.xlabel('Models')
    plt.ylabel('Score (%)')
    plt.legend()
    plt.grid(True)
    ...
    plt.tight_layout()
    line_graph_path = os.path.join(base_path, 'hindi_cleaned_output3_line_graph.png')
